...
//import {Breadcrumb, BreadcrumbItem, Button, Form, FormGroup, Label, Input, Col,  FormFeedback } It is replace for react-redux-form from 'reactstrap';
...
//function Contact(props) { replace for using component class for keep form state
render() {
